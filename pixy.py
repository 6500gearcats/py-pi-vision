...
class BlockArray(_object):
    ...
    def __getitem__(self, index: 'size_t') -> "Block":
...
def BlockArray_frompointer(t: 'Block') -> "BlockArray *":
...
class VectorArray(_object):
    ...
    def __getitem__(self, index: 'size_t') -> "Vector":
        return _pixy.VectorArray___getitem__(self, index)

    def __setitem__(self, index: 'size_t', value: 'Vector') -> "void":
...
def VectorArray_frompointer(t: 'Vector') -> "VectorArray *":
...
class IntersectionLineArray(_object):
    ...
    def __getitem__(self, index: 'size_t') -> "IntersectionLine":
        return _pixy.IntersectionLineArray___getitem__(self, index)

    def __setitem__(self, index: 'size_t', value: 'IntersectionLine') -> "void":
        return _pixy.IntersectionLineArray___setitem__(self, index, value)

    def cast(self) -> "IntersectionLine *":
...
def IntersectionLineArray_frompointer(t: 'IntersectionLine') -> "IntersectionLineArray *":
...
class BarcodeArray(_object):
    ...
    def __getitem__(self, index: 'size_t') -> "Barcode":
        return _pixy.BarcodeArray___getitem__(self, index)

    def __setitem__(self, index: 'size_t', value: 'Barcode') -> "void":
...
def BarcodeArray_frompointer(t: 'Barcode *') -> "BarcodeArray *":
...
def change_prog(program_name: 'char const *') -> "int":
...
def ccc_get_blocks(max_blocks: 'int', blocks: 'BlockArray') -> "int":
    return _pixy.ccc_get_blocks(max_blocks, blocks)
ccc_get_blocks = _pixy.ccc_get_blocks

def line_get_all_features() -> "void":
